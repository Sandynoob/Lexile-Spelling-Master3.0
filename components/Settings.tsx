  ...
  return (
    <div className="p-6 flex flex-col items-center animate-pop">
      <div className="flex flex-col items-center mb-8">
        <div className="w-32 h-32 bg-indigo-600 rounded-[2rem] flex flex-col items-center justify-center shadow-xl mb-4 p-2">
          <span className="text-white font-kids text-6xl mb-1">L</span>
          <span className="text-white font-kids text-[10px] text-center leading-tight opacity-90">
      ...
      <div className="w-full space-y-4">
        ...
        <div className="bg-white p-5 rounded-3xl border border-indigo-50 shadow-sm">
          ...
          <p className="text-slate-600 text-sm leading-relaxed">
            Lexile Spelling Master is a professional spelling assessment tool designed for students. 
      ...
      <div className="mt-12 text-center">
        <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">
          © 2026 Lexile Spelling Master Team
        </p>
      </div>
    </div>
  );
